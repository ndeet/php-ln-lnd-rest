...
/**
 * LnrpcWalletAccountBalance Class Doc Comment
 *
 * @category Class
 * @package  Lnd\Rest
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LnrpcWalletAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'lnrpcWalletAccountBalance';
     ...
     *
     * @param string $confirmedBalance The confirmed balance of the account (with >= 1 confirmations).
     *
     * @return $this
     */
     ...
     *
     * @param string $unconfirmedBalance The unconfirmed balance of the account (with 0 confirmations).
     *
     * @return $this
     */
