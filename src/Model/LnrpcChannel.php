...
class LnrpcChannel implements ModelInterface, ArrayAccess
{
     ...
     * Sets csvDelay
     *
     * @param int $csvDelay * The CSV delay expressed in relative blocks. If the channel is force closed, we'll need to wait for this many blocks before we can regain our funds.
     *
     * @return $this
     */
